...
export function TyphoonComposer({
  ...
  return (
    <div className="pointer-events-none absolute inset-x-0 bottom-0 z-10 flex justify-center">
      ...
      <div className="pointer-events-auto relative z-10 w-[min(720px,100%)] px-5 pb-5 pt-3">
        <PromptInput
          onSubmit={handleSubmit}
          className="flex items-end gap-2 rounded-xl border border-border bg-card p-2.5 shadow-lg shadow-black/50 transition-shadow duration-150 focus-within:shadow-black/60"
        >
          <PromptInputTextarea
            value={input}
